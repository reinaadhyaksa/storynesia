...
export const StorynesiaLoadingScreen = () => (
    <div className="fixed inset-0 bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 flex flex-col items-center justify-center z-50">
        <div className="text-center">
            <div className="w-16 h-16 border-4 border-purple-300 border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
            <h2 className="text-xl text-white font-semibold mb-2">Storynesia</h2>
        </div>
    </div>
)
        ...
        <div>
            ...
            <div className="flex flex-wrap gap-2 mb-3">
                {defaultAvatars.map((avatar, index) => (
                    <div
                        key={index}
                        className={`w-12 h-12 rounded-full overflow-hidden cursor-pointer border-2 ${selectedAvatar === avatar ? 'border-purple-500' : 'border-gray-300'}`}
